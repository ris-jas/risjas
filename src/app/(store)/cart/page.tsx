...
const title = "Risjas Cart | Review Items and Checkout Securely Fast";
const description =
  "Review items in your Risjas cart, update quantities, and continue to secure checkout with transparent pricing, fast shipping options, and trusted order support.";

export default function CartPage() {
  const [cart, setCart] = useState<any>(null);
  const pageSchema = createWebPageSchema({ title, description, path: "/cart" });
  ...
  return (
    <>
      <SeoJsonLd id="cart-page-schema" schema={pageSchema} />
